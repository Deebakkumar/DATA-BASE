db.product.insertMany([
    ...
    },
    {
        ...
        "product_price":20.00,
        "product_material": "Cotton",
        "product_colproductsor": "indigo"
    }
])

db.products.find().toArray()
db.products.find($and:[{u1:{$gt:400}},{u1:{$lt:800}}])       
db.products.find($and:[{u1:{$lt:400}},{u1:{$gt:600}}])
db.products.find( { quantity: { $gt: 500 } } ) 
db.products.find({},{product_name:1,product_material:1}).pretty()
db.products.find({id:{$type:'string'},id:"10"}).pretty()
db.products.findOne(product_name,product_material)
db.products.find({product_material:"soft"}).pretty()
db.products.find({$or:[{product_color:"indigo"},{product_price:"492"}]})Pretty()
db.products.deleteMany( { product_price: "20" } )
